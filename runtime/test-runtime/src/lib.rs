...
use zaxis_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
use primitives::v1::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("zaxis-test-runtime"),
	impl_name: create_runtime_str!("parity-zaxis-test-runtime"),
	authoring_version: 2,
	spec_version: 1056,
	impl_version: 0,
