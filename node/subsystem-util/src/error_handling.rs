...
//! Utilities for general error handling in Z-Axis.
//!
//! Goals:
//!
...
/// ```
/// use thiserror::Error;
/// use zaxis_node_subsystem::errors::RuntimeApiError;
/// use zaxis_primitives::v1::SessionIndex;
/// use futures::channel::oneshot;
/// use zaxis_node_subsystem_util::{Fault, runtime};
///
/// #[derive(Debug, Error)]
/// #[error(transparent)]
...
/// ```no_run
/// # use thiserror::Error;
/// # use zaxis_node_subsystem_util::{Fault, unwrap_non_fatal};
/// # use zaxis_node_subsystem::SubsystemError;
/// # #[derive(Error, Debug)]
/// # enum Fatal {
/// # }
/// # #[derive(Error, Debug)]
