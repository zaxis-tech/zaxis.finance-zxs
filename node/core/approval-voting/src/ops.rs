...
use zaxis_node_subsystem::SubsystemResult;

use bitvec::order::Lsb0 as BitOrderLsb0;
use zaxis_primitives::v1::{BlockNumber, CandidateHash, CandidateReceipt, GroupIndex, Hash};
...
pub fn canonicalize(
	...
	// TODO https://github.com/paritytech/zaxis/issues/3389
